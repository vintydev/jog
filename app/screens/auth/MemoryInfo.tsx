...
const MemoryInfoScreen: React.FC<AuthStackScreenProps<"MemoryInfo">> = ({ navigation, route }) => {
    ...
    const handleNext = () => {
        ...
        navigation.navigate("ConcentrationInfo", {
            selections: {
                ...selections,
                memorySeverity: adhdSeverity,
    ...
    return (
        ...
        <AuthLayout>
            ...
            <Text className="text-2xl font-sf-pro-bold mb-5 text-center">How would you generally rate your memory?</Text>
